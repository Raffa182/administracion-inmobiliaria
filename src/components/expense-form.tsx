    ...
    <form onSubmit={onSubmit} className="space-y-3">
      ...
      <div className="flex gap-3">
        <input
          ...
          placeholder="Monto"
          required
          className="flex-1 rounded-lg border border-slate-300 dark:border-slate-700 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-slate-900 dark:focus:ring-slate-100"
        />
        <button
          type="submit"
          disabled={loading}
