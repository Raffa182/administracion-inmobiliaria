  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-1">
        ...
        {options.length > 0 && (
          <button
            ...
            className="text-xs text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-50 underline"
          >
      ...
      {!creating ? (
        ...
        <div className="space-y-3 rounded-lg border border-dashed border-slate-300 dark:border-slate-700 p-3">
          {children}
        </div>
      )}
    </div>
